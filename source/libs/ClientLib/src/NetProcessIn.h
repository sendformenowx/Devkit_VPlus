...
#include "GObj.h"
#include "Test/Test.h"
#include "..\..\..\third-party\memory\include\memory\hook.h"
...
public:
    void EventSuitRegionId(CMsgStreamBuffer& msg);
    void SavedLocations(CMsgStreamBuffer &msg);
    void AttendanceRewards(CMsgStreamBuffer& msg);
    void AttendanceEvent(CMsgStreamBuffer& msg);
    static BYTE AttendanceSetting;
    static BYTE EventMenuSetting;
    static BYTE FacebookSetting;
    static BYTE DiscordSetting;
    static BYTE ChestSetting;
    static INT64 DiscordID;
    static std::n_string DiscordURL;
    static std::n_string FacebookURL;
    static int PartyMaxLevel;
    static byte FvkingInventorySlot;
    static bool  CharDead;
    /// menu
    void RegisterStatus(CMsgStreamBuffer &msg);
    void NoticeColor(CMsgStreamBuffer &msg);
    void UniqueLog(CMsgStreamBuffer &msg);
    void DynamicRanking(CMsgStreamBuffer &msg);
    void LoadChest(CMsgStreamBuffer &msg);
    void AddItemChest(CMsgStreamBuffer &msg);
    void RemoveItemChest(CMsgStreamBuffer &msg);
    void Charlock(CMsgStreamBuffer &msg);
    void TitleManager(CMsgStreamBuffer &msg);
    void TitleManageriSro(CMsgStreamBuffer &msg);   
    void TitleManagerColors(CMsgStreamBuffer &msg);    
    
    
    void BotSettings(CMsgStreamBuffer &msg);
    
    
    void CharAnalyzer(CMsgStreamBuffer &msg);
    void EventSchedule(CMsgStreamBuffer &msg);
    void ChangeLog(CMsgStreamBuffer &msg);
    /// icons
    void LeftCharIconPath(CMsgStreamBuffer &msg);
    void LeftCharIcon(CMsgStreamBuffer &msg);
    void UpdateLeftIcon(CMsgStreamBuffer &msg);
    void RemoveLeftIcon(CMsgStreamBuffer& msg);
    void RightIconPath(CMsgStreamBuffer& msg);
    void RightIcon(CMsgStreamBuffer& msg);
    void UpdateRightIcon(CMsgStreamBuffer &msg);
    void RemoveRightIcon(CMsgStreamBuffer &msg);
    void UpCharIconPath(CMsgStreamBuffer &msg);
    void UpCharIcon(CMsgStreamBuffer &msg);
    void UpdateUpIcon(CMsgStreamBuffer &msg);
    void RemoveUpIcon(CMsgStreamBuffer& msg);
    /// colors
    void CharNameColor(CMsgStreamBuffer& msg);
    void UpdateNameColor(CMsgStreamBuffer& msg);
    void RemoveNameColor(CMsgStreamBuffer& msg);
    void TitleColor(CMsgStreamBuffer &msg);
    void UpdateTitleColor(CMsgStreamBuffer &msg);
    void RemoveTitleColor(CMsgStreamBuffer &msg);
    /// new titles

    void NewCostomTitleAdd(CMsgStreamBuffer& msg);
    void NewCostomTitlesAddAll(CMsgStreamBuffer& msg);
    void NewisroTitlesAdd(CMsgStreamBuffer& msg);
    void NewisroTitlesAddAll(CMsgStreamBuffer& msg);


    void NewTitles(CMsgStreamBuffer& msg);
    void UpdateNewTitles(CMsgStreamBuffer &msg);
    void RemoveNewTitles(CMsgStreamBuffer &msg);
    ///others
    void DpsMeter(CMsgStreamBuffer &msg);
    void SurvivalKills(CMsgStreamBuffer &msg);
    void FtwPlayerKills(CMsgStreamBuffer &msg);
    void FtwGuildKills(CMsgStreamBuffer &msg);
    void FtwUnionKills(CMsgStreamBuffer &msg);
    void LinkedItemColor(CMsgStreamBuffer &msg);
    ...
    void On3535(CMsgStreamBuffer &msg);
    /// \address 0x008A9260
